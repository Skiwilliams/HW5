...
int main() {
  ...
  // This code is not a complete test code (won't even compile) and it may be
  // syntactically inconsistent with your class definitions. So modify before
  // use as appropriate. But the idea of testing should be clear. You are free
  // to shuffle around the order of operations in order to devise more test
  // cases of your own.
